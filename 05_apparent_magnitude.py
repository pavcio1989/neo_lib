...
def reduce_mag(abs_mag: float, phase_angle: float, slope_g: float = 0.15) -> float:
    """
...
def hg_app_mag(
    ...
    red_mag = reduce_mag(abs_mag, obj_phase_angle, slope_g)
...
# Earth & Eros position determination
